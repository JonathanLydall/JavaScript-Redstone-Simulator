...
/**
 * Quickly implemented and simple wrapper class which allows PHP password hashing framework functions
 * to be called statically. Written by jonathan.lydall@gmail.com.
 */
class phpPass {
	...
	{
		self::init();
		return self::$passwordHash->CheckPassword($password, $stored_hash);
	}
}
